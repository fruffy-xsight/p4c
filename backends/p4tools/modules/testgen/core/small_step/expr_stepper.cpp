...
/// @returns true when @p type describes an extern object. An instance of a generic extern
/// carries a specialization of the declaration rather than the declaration itself.
